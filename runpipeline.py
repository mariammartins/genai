...
class vertex_ai_pipeline:
    def __init__(self,
                 PROJECT_ID: str = "prj-p-bu3machine-learning-914j",
                 PROD_PROJECT_ID: str = 'prj-p-bu3machine-learning-914j',
                 ...
                 DATAFLOW_SUBNET: str = "https://www.googleapis.com/compute/v1/projects/prj-p-shared-restricted-5wp3/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1",
        ...
        self.Image = "us-central1-docker.pkg.dev/prj-c-bu3artifacts-dth3/c-publish-artifacts/vertexpipeline:v2"
        ...
        self.deployment_config = {
            ...
            "encryption": 'projects/prj-p-kms-d62d/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-p-bu3machine-learning',
            "service_account": self.SERVICE_ACCOUNT,
            "prod_service_account": self.PROD_SERVICE_ACCOUNT
        }

        self.monitoring_config = {
            'email': 'mariamartins@clsecteam.com',
    ...
    def execute(self):
        pipeline = aiplatform.PipelineJob(
            ...
            encryption_spec_key_name='projects/prj-p-kms-d62d/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-p-bu3machine-learning',
            parameter_values={
...
if __name__ == "__main__":
    pipeline = vertex_ai_pipeline(
        ...
        PROD_PROJECT_ID='prj-p-bu3machine-learning-914j', \  # Replace with your prod project Id
        REGION="us-central1", \
        BUCKET_URI="gs://bkt-p-bucket-genai", \  # Replace with your bucket in non-prod
        DATA_PATH="data", \
        ...
        DATAFLOW_SUBNET="https://www.googleapis.com/compute/v1/projects/prj-p-shared-restricted-5wp3/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1",
        JOB_NAME="census-ingest", \
        # Replace with the compute default service account of your non-prod project
        SERVICE_ACCOUNT="398150576350-compute@developer.gserviceaccount.com", \
        # Replace with the compute default service account of your prod project
        PROD_SERVICE_ACCOUNT="398150576350-compute@developer.gserviceaccount.com"
    )
